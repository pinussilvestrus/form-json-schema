...
export const errors = [
  {
    ...
    schemaPath: '#/properties/components/items/allOf/0/allOf/2/then/anyOf/0/required',
    keyword: 'required',
  ...
  {
    instancePath: '/components/0',
    schemaPath: '#/properties/components/items/allOf/0/allOf/2/then/anyOf/1/required',
    keyword: 'required',
  ...
  {
    instancePath: '/components/0',
    schemaPath: '#/properties/components/items/allOf/0/allOf/2/then/anyOf/2/required',
    keyword: 'required',
  ...
  {
    instancePath: '/components/0',
    schemaPath: '#/properties/components/items/allOf/0/allOf/2/then/anyOf',
    keyword: 'anyOf',
    params: {},
